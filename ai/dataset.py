...
class mydata(Dataset):
    def __init__(self, LR_path, GT_path, in_memory=True, transform=None):
        ...
        self.LR_img = sorted([f for f in os.listdir(LR_path) if f.lower().endswith(('.png', '.jpg', '.jpeg', '.bmp', '.gif'))])
        self.GT_img = sorted([f for f in os.listdir(GT_path) if f.lower().endswith(('.png', '.jpg', '.jpeg', '.bmp', '.gif'))])
